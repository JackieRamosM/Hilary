 ...
 * @param  {Function}   callback                Standard callback method that will be executed when the listener functions has been subscribed to the queue
 */
var bind = module.exports.bind = function(taskQueueId, listener, options, callback) {
	console.log("en bind $$$$$$$$$$$$$$$$$$$$");
    options = options || {};
    ...
    _declareQueue(taskQueueId, queueOptions, function(err) {
        if (err) {
            return callback(err);
        }
         ...
         */
        MQ.bindQueueToExchange(taskQueueId, Constants.DEFAULT_TASK_EXCHANGE_NAME, taskQueueId, function(err) {
            if (err) {
                return callback(err);
            }
 ...
 * @see bind
 */
var _declareQueue = function(taskQueueId, queueOptions, callback) {
 ...
 * @param  {Function}   callback        Standard callback function that will be executed when the consumer has been unbound. Note that the consumer might still be processing a task, but it will receive no further new tasks
 * @param  {Object}     callback.err    An error that occurred, if any
 */
var unbind = module.exports.unbind = function(taskQueueId, callback) {
 ...
 * @param  {Function}   callback        Standard callback method that will be executed when the task has been submitted
 */
var submit = module.exports.submit = function(taskQueueId, taskData, callback) {
	console.log("en taskqueue ///////////////////");
