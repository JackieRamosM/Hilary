...
DiscussionsAPI.on(DiscussionsConstants.events.CREATED_DISCUSSION, function(ctx, discussion, members) {
    ...
    console.log("======================== Seed",activitySeed, activitySeed.objectResource.resourceData.discussion.tenant);
...
var _discussionProducer = function(resource, callback) {
	console.log("En discussionproducer");
    ...
    if (discussion) {
	console.log("discussion llega lleno");
	console.log("la discusion es", discussion);
	...
	console.log("discussion llega null");
        return callback(null, _createPersistentDiscussionActivityEntity(discussion));
    });
};
...
var _createPersistentDiscussionActivityEntity = function(discussion) {
 	console.log("en createPersistentDiscussionActivityEntity");
	...
	console.log("persistentEntityID", persistentEntity[ActivityConstants.properties.OAE_ID]);
...
var _discussionTransformer = function(ctx, activityEntities, callback) {
	console.log("en _discussionTransformer");
    ...
    _.each(activityEntities, function(entities, activityId) {
		...
		console.log("a3", transformedActivityEntities[activityId][entityId]);
        });
    });
 ...
 * @see ActivityAPI#registerActivityEntityType
 */
var _discussionInternalTransformer = function(ctx, activityEntities, callback) {
	console.log("en _discussionInternaTransformer");
    var transformedActivityEntities = {};
...
var _transformPersistentDiscussionActivityEntity = function(ctx, entity) {
	...
	console.log("\n\n\n en transformPersistentDisucssionActivityEntity");
    var discussion = entity.discussion;
	console.log("entity", entity.discussion);
	...
	console.log("a4",discussion.profilePath);
...
var _discussionMessageTransformer = function(ctx, activityEntities, callback) {
    ...
    _.keys(activityEntities).forEach(function(activityId) {
        ...
        _.keys(activityEntities[activityId]).forEach(function(entityId) {
            ...
            var discussionId = entity.discussionId;
 ...
 * @see ActivityAPI#registerActivityEntityType
 */
var _discussionMessageInternalTransformer = function(ctx, activityEntities, callback) {
    var transformedActivityEntities = {};
    _.keys(activityEntities).forEach(function(activityId) {
        transformedActivityEntities[activityId] = transformedActivityEntities[activityId] || {};
        _.keys(activityEntities[activityId]).forEach(function(entityId) {
...
ActivityAPI.registerActivityEntityType('discussion', {
	...
	console.log("a1",entity.discussion.visibility);
	console.log("a2", AuthzConstants.joinable.NO);
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion', 'self', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion-message', 'self', function(associationsCtx, entity, callback) {
