...
var LIBRARY_INDEX_NAME = 'meeting:meeting';

var createMeeting = module.exports.createMeeting = function(ctx, displayName, description, welcomemessage, members, opts, callback){
	...
	MeetingDAO.createMeeting(id, displayName, description, welcomemessage, visibility,function(err,data){
		if (err) {
			return callback(err);
		}
		...
		var meeting = {
		 ...
		 AuthzAPI.updateRoles(meeting.id, members, function(err) {
			...
			_insertLibrary(_.keys(members), meeting, function(err) {
				...
				console.log("!!!!!!!!!!!!!!!!",MeetingConstants.events.CREATED_MEETING);
