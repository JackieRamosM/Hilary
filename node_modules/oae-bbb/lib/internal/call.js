...
var createBBBCall = exports.createBBBCall = function (meetingID, name, duration, record,  welcomeMessage, meetingname,callback){
		
	var attendeePW = meetingID.substr(meetingID.length - 4);
        var params = "meetingID=" + encodeURIComponent(meetingID) + "&attendeePW=" + encodeURIComponent(attendeePW) + "&welcome=" + encodeURIComponent(welcomeMessage) + "&record=" + record + "&duration=" + duration + "&name=" + encodeURIComponent(meetingname);
